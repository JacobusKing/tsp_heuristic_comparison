...
from solver import example_solver
...
tour = example_solver(dist_matrix, time_limit)
...
plot_tour(coords, optimal_tour, filename = 'optimal.pdf', heading = f"Optimal tour: {round(optimal_total_distance, 2)}")
